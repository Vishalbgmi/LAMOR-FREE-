...
BOT_TOKEN = os.getenv("8916117566:AAH2p58FbI1XAzKH-hdKOOmLaV9jmMsXuz0")
MONGODB_URI = os.getenv("MONGODB_URI")
DATABASE_NAME = os.getenv("DATABASE_NAME", "attack_bot")
API_URL = os.getenv("API_URL")
API_KEY = os.getenv("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")
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "5268737363").split(",")]
